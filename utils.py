...
def cvat2yolo(json_file,img_path):
    ...
    for img in img_data:
        ...
        shutil.copy(full_img_path,os.path.join('yolov5',cur_img))
        ...
        for cur_match in annt_match:
            ...
            with open(os.path.join('yolov5',cur_img.replace('.jpg','.txt')), 'a+') as f:
...
def sort_videos(videofolder):
    ...
    for vidpath in all_vid_names:
        ...
        for frame_gropu in img_groups:
            ...
            th, dframe = cv2.threshold(medianFrame, 150, 200, cv2.THRESH_BINARY)
